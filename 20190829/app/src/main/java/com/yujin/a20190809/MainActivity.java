...
/*
하고싶은거ㄱ-
1. 슬라이딩 판정 속도와 방향까지 판단!
2. 부드럽게 슬라이딩 되도록! -> 뷰페이저???????
3. 페이지 추가하고 삭제하는 기능
4. 북마크!
 */
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final VelocityTracker mVelocityTracker = null;


        //화면 전환을 위한 드래그 속도의 최소값
        final int SNAP_VELOCITY = 100;

        //터치이벤트인가 화면전환을 위한 터치인지 이동거리 기준으로 알아보기
        int mTouchSlop = 10;
        */
